...
# puts "ticketac p2"
# url = "https://www.ticketac.com/recherche-personnalisee/gr=one-man-show-et-cafe-theatre_gr=theatre_gr=musique-comedie-musicale_re=paris_da=2018-08-29?page=2"
# html_file = open(url).read
# html_doc = Nokogiri::HTML(html_file)

# html_doc.search('.tt14-tit a').each do |element|
#   puts element.text.strip
# end

puts "billets reduc p6"

url2 = "https://www.billetreduc.com/search.htm?cp=Paris&dt=2018-08&idrub=103,68,90&jj=29&nbsalle=0&prix=0&tri=date&type=3,3&LISTEPEpg=6"
html_file2 = open(url2).read
html_doc2 = Nokogiri::HTML(html_file2)

html_doc2.search('.bgbeige h4 a').each do |element|
  puts element.text.strip
end
